        ...
        <div className="min-w-100">
          ...
          <form className="mt-4 flex ">
            <input
              ...
              className="w-full p-2 text-[25px] bg-white rounded-l-md border border-white-500 text-black focus:outline-none focus:ring-2 "
            />
            <button
              type="submit"
              className="bg-emerald-600 text-[25px]  text-white px-4 rounded-r-md hover:bg-red-700 cursor-pointer"
            >
              Subscribe
            </button>
          </form>
